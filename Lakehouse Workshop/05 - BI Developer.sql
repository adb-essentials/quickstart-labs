...
-- MAGIC 
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/NewLabImages/PBI2.png" width="1200">
...
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/NewLabImages/PBI3.png" width="200">
...
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/NewLabImages/PBI4.png" width="800">

-- COMMAND ----------

-- MAGIC %md
-- MAGIC ### Open a new browser tab. In the lefthand navigation, change the persona switcher to SQL  
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/DBSQL2.png" width="300">
-- MAGIC 
-- MAGIC ### Click on SQL Warehouses, click on the SQL Warehouse for your lab environment, click on connection details  
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/NewLabImages/PBI1.png" width="800">

-- COMMAND ----------

-- MAGIC %md
-- MAGIC ### With the Power BI Parameters updated, Click Refresh, you can now browse the `UserDB` database in Power BI    
-- MAGIC <img src="https://github.com/adb-essentials/quickstart-labs/blob/c8be0896dc688c045ec3866e1fc744981f47b844/DLT11.png" width="800">
